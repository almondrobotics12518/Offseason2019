...
import static com.disnodeteam.dogecv.DogeCV.CameraMode.FRONT;
...
*/
    ...
    public final void detectorEnable()
    {
        ...
        detector.init(hardwareMap.appContext, CameraViewDisplay.getInstance(),FRONT,false); // Initialize it with the app context and camera
